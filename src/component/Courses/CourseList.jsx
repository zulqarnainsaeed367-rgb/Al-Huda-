    ...
    return (
        <div className="grid md:grid-cols-2 gap-8">
            {courses.map((course, index) => (
                ...
                >
                    <h3 className="text-2xl font-bold text-[#F4C430] mb-4">
                        {course.title}
                    </h3>
                    ...
                    <div className="mb-4">
                        <p>
                            <span className="text-[#D4AF37]">Age Group:</span> {course.ageGroup}
                        </p>
                        <p>
                            <span className="text-[#D4AF37]">Duration:</span> {course.duration}
                        </p>
                    </div>
